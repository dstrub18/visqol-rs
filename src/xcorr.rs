...
fn calculate_inverse_fft_pointwise_product(signal_1: &Array2<f64>, signal_2: &Array2<f64>)
-> Vec<f64> {
...
fn calculate_fft_pointwise_product(signal_1: &Vec<f64>, signal_2: &Vec<f64>, manager: &mut FftManager, fft_points: usize)
