...
pub fn forward_1d_from_matrix(fft_manager: &mut FftManager, in_matrix: &[f64])
-> Vec<Complex64> {
...
pub fn forward_1d_from_points(fft_manager: &mut FftManager, in_matrix: &[f64], points: usize)
-> Vec<Complex64> {
...
pub fn inverse_1d(fft_manager: &mut FftManager, in_matrix: &[Complex64])
-> Vec<Complex64> {
...
pub fn inverse_1d_conj_sym(fft_manager: &mut FftManager, in_matrix: &[Complex64])
-> Vec<f64>
{
